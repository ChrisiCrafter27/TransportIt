...
import de.chrisicrafter.transportit.block.custom.PoweredPoweredRailBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> POWERED_POWERED_RAIL = registerBlock("powered_powered_rail", () -> new PoweredPoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL)));
