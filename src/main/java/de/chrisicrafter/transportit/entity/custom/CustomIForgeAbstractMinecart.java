...
public interface CustomIForgeAbstractMinecart {
    ...
    private CustomAbstractMinecart self() {
        return (CustomAbstractMinecart) this;
    }
    ...
    default boolean isPoweredCart() {
        return self().getMinecartType() == CustomAbstractMinecart.Type.FURNACE;
    }
    ...
    default boolean canBeRidden() {
        return self().getMinecartType() == CustomAbstractMinecart.Type.RIDEABLE;
    }
